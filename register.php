...
<head>
  ...
  <title>Aplikasi Pengaduan - Registrasi</title>
              ...
              <div class="col-lg-12">
                <div class="p-5">
                  <div class="text-center">
                    <h1 class="h4 text-gray-900 mb-4">Silahkan Daftar!</h1><h2 class="h4 text-gray-900 mb-4">Aplikasi Pengaduan Masyarakat</h2>
                  </div>
                  <form class="user" method="post" action="simpan_masyarakat.php">
                    ...
                    <div class="form-group">
                      <input type="text" name="nama" class="form-control form-control-user" id="exampleInputEmail" aria-describedby="emailHelp" placeholder="Masukkan Nama...">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      <input type="text" name="telepon" class="form-control form-control-user" id="exampleInputEmail" aria-describedby="emailHelp" placeholder="Masukkan No Telp/HP...">
                    </div>
                  ...
                  <div class="text-center">
                    <a class="small" href="index.php">Login Di Sini!</a>
                  </div>
                </div>
              </div>
            </div>
