              ...
              <div class="col-lg-12">
                <div class="p-5">
                  <div class="text-center">
                    <h1 class="h4 text-gray-900 mb-4">Selamat Datang!</h1><h2 class="h4 text-gray-900 mb-4">Aplikasi Pengaduan Masyarakat</h2>
                  </div>
                  ...
                  <div class="text-center">
                    <a class="small" href="register.php">Silahkan Daftar! Gratis!</a>
                  </div>
                  <hr>
                  <div class="text-center">
                    <a class="small" href="admin/index.php">Masuk Sebagai Admin</a>
                  </div>
                </div>
              </div>
            </div>
