 ...
 <!-- DataTales Example -->
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              <h3 class="m-0 font-weight-bold text-primary">Data Pengaduan Masyarakat</h3>
                <br>
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                        ...
                        -->
                        <a href="hapus_pengaduan_admin.php?id_pengaduan=<?php echo $data['id_pengaduan']; ?>" class="btn btn-danger btn-icon-split" onclick="return confirm('Yakin Hapus?')">
                          <span class="icon text-white-50">
